      ...
      switch (event.type) {
        case "account.updated": {
          ...
          const organization = await Organization.retrieve(
            account.metadata.organization_id
          );
        ...
        case "customer.created": {
          ...
          await Database.pool
            .query(
              ...
              [customer.id, customer.metadata.user_id]
            )
            .catch(() => {
              throw Boom.badImplementation();
            });
        ...
        case "customer.updated": {
          ...
          if (customer.invoice_settings.default_payment_method !== null) {
            ...
            paymentMethod = await PaymentMethod.retrieveWithStripeId(
        ...
        case "invoice.paid": {
          ...
          const subscription = await Subscription.retrieveWithSubscriptionId(
        ...
        case "payment_method.attached": {
          ...
          const user = await User.retrieveWithCustomerId(
        ...
        case "payment_method.detached": {
          ...
          await Database.pool
            .query(`delete from "payment_methods" where "stripe_id" = $1`, [
              paymentMethod.id,
            ])
            .catch(() => {
              throw Boom.badImplementation();
        ...
        case "price.created": {
          ...
          await Database.pool
            .query(
              ...
              [price.id, price.metadata.price_id]
            )
            .catch(() => {
              throw Boom.badImplementation();
            });
        ...
        case "product.created": {
          ...
          await Database.pool
            .query(
              ...
              [product.id, product.metadata.bundle_id]
            )
            .catch(() => {
              throw Boom.badImplementation();
            });
