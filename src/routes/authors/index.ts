...
export default <ServerRoute[]>[
  {
    ...
    handler: async (request, h) => {
      ...
      const author = await Author.retrieve(
        request.params.id,
  ...
  },
  {
    ...
    handler: async (request, h) => {
      ...
      const authors = await Author.forPublisher(
        publisher,
        request.query.expand
      );
  ...
  },
  {
    ...
    handler: async (request, h) => {
      ...
      const authors = request.query.publisher
        ? [
            await Author.retrieveWithUserAndPublisher(
              authenticatedUser,
      ...
      return authors.map((author) =>
        author.serialize({ for: authenticatedUser })
      );
    },
  },
  {
